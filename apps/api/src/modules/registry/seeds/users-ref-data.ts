export class UsersRefData {
  static firstNames = ["Aleksander", "Andriy", "Anton", "Apostol", "Avel", "Bodashka", "Bogdan", "Bohdan", "Bohdanko", "Boiany", "Borysko", "Burian", "Danilo", "Danya", "Danylets", "Danylko", "Danylo", "Dmytro", "Faddei", "Fadey", "Fadeyka", "Fadeyushka", "Fedir", "Hadeon", "Heorhiy", "Hryhoriy", "Ilarion", "Ivan", "Krystiyan", "Kyrylo", "Lyaksandro", "Matviyko", "Mikhaila", "Mychajlo", "Mykhaila", "Mykhailo", "Mykhaltso", "Mykhaylo", "Olek", "Oleksander", "Oleksandr", "Oleksiy", "Osip", "Pavlo", "Petro", "Petruso", "Pylyp", "Symon", "Taras", "Timofy", "Vanko", "Vasyl", "Vasylko", "Volodimir", "Volodymyr", "Wasyl", "Wolodymyr", "Yakiv", "Yevhen", "Yevheniy", "Yosyp", "Yure"];
